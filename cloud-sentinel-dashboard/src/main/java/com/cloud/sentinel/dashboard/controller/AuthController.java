...
import com.cloud.sentinel.dashboard.auth.SimpleWebAuthServiceImpl;
import com.cloud.sentinel.dashboard.config.DashboardConfig;
...
public class AuthController {
    ...
    public Result<AuthService.AuthUser> login(HttpServletRequest request, String username, String password) {
        ...
        /*
         * If auth.username or auth.password is blank(set in application.properties.back or VM arguments),
