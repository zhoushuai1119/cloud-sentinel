...
public class AuthorityRuleApolloPublisher implements DynamicRulePublisher<List<AuthorityRuleEntity>> {
    ...
    private final Logger logger = LoggerFactory.getLogger(AuthorityRuleApolloPublisher.class);
    ...
    public void publish(String app, List<AuthorityRuleEntity> rules) {
        ...
        logger.info("set app : {} AuthorityRule success rules: {}", app, JSON.toJSONString(rules));
    }
